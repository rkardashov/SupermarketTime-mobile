...
:: Android packaging
set AND_CERT_NAME="supermarket time mobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\supermarkettimemobile.p12
...
set IOS_PROVISION=cert\supermarkettimemobile.mobileprovision
...
set APP_ID=air.supermarkettimemobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=supermarkettimemobile
